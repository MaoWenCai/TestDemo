...
<body class="hold-transition skin-blue-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
		    ...
		    <form id="editForm" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/product/sustain/noticeRemind/${action}" method="post">
			<hyb:token/>
			<hyb:hidden name="id" value="${remind.id}"/>
